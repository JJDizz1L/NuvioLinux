...
import com.nuviolinux.app.features.p2p.formatP2pMegabytes
import com.nuviolinux.app.features.p2p.formatP2pSpeed
import com.nuviolinux.app.features.player.skip.SkipIntroRepository
...
import com.nuviolinux.app.features.discord.DiscordPlaybackPresenceEffect
...
internal fun PlayerScreenRuntime.RenderPlayerRuntimeUi() {
    ...
    val p2pPeerInfo = p2pStats?.let { stats ->
        org.jetbrains.compose.resources.stringResource(
            nuviolinux.composeapp.generated.resources.Res.string.player_torrent_peer_info,
            stats.seeds,
            stats.peers,
        )
    }
    ...
    val p2pInitialLoadingMessage = when {
        ...
        p2pConnecting != null -> {
            if (p2pSettingsUiState.hideTorrentStats) {
                ...
                org.jetbrains.compose.resources.stringResource(
                    nuviolinux.composeapp.generated.resources.Res.string.player_torrent_connecting_status,
                    p2pConnectingPhaseLabel(p2pConnecting.phase),
        ...
        p2pStats != null -> {
            if (p2pSettingsUiState.hideTorrentStats) {
                ...
                org.jetbrains.compose.resources.stringResource(
                    nuviolinux.composeapp.generated.resources.Res.string.player_torrent_loading_status,
            ...
            nuviolinux.composeapp.generated.resources.Res.string.player_torrent_starting_engine,
        )
    }
...
private fun p2pConnectingPhaseLabel(phase: String): String = when (phase) {
    "add_magnet" -> org.jetbrains.compose.resources.stringResource(
        nuviolinux.composeapp.generated.resources.Res.string.player_torrent_fetching_metadata,
    )
    "prepare_stream", "attach_route" -> org.jetbrains.compose.resources.stringResource(
        nuviolinux.composeapp.generated.resources.Res.string.player_torrent_preparing_stream,
    )
    else -> org.jetbrains.compose.resources.stringResource(
        nuviolinux.composeapp.generated.resources.Res.string.player_torrent_starting_engine,
    )
