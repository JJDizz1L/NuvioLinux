package com.nuviolinux.app.features.cloud

import com.nuviolinux.app.features.debrid.DebridProviders
import com.nuviolinux.app.features.debrid.TorboxApiClient
import com.nuviolinux.app.features.debrid.TorboxCloudFileDto
import com.nuviolinux.app.features.debrid.TorboxCloudItemDto
...
internal class TorboxCloudLibraryProviderApi : CloudLibraryProviderApi {
    ...
    private fun com.nuviolinux.app.features.debrid.DebridApiResponse<com.nuviolinux.app.features.debrid.TorboxEnvelopeDto<List<TorboxCloudItemDto>>>.itemsOrThrow(
...
internal fun com.nuviolinux.app.features.debrid.DebridApiResponse<com.nuviolinux.app.features.debrid.TorboxEnvelopeDto<List<TorboxCloudItemDto>>>.toCloudLibraryItemsOrThrow(
    providerId: String,
    providerName: String,
    type: CloudLibraryItemType,
): List<CloudLibraryItem> {
