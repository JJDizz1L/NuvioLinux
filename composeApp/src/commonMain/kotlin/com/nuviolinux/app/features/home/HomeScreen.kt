...
import com.nuviolinux.app.core.ui.NuvioScreen
import com.nuviolinux.app.core.ui.NuvioNetworkOfflineCard
import com.nuviolinux.app.core.ui.nuvioSafeBottomPadding
import com.nuviolinux.app.core.ui.rememberHeroStretchState
import com.nuviolinux.app.core.ui.rememberPosterCardStyleUiState
import com.nuviolinux.app.core.ui.withDuplicateSafeLazyKeys
import com.nuviolinux.app.features.addons.AddonRepository
import com.nuviolinux.app.features.addons.enabledAddons
...
import com.nuviolinux.app.features.cloud.CloudLibraryUiState
import com.nuviolinux.app.features.cloud.findPlaybackTargetForProgress
import com.nuviolinux.app.features.details.MetaDetails
import com.nuviolinux.app.features.details.MetaDetailsRepository
import com.nuviolinux.app.features.details.MetaVideo
import com.nuviolinux.app.features.details.SeriesPrimaryAction
import com.nuviolinux.app.features.details.seriesPrimaryAction
import com.nuviolinux.app.features.home.components.HomeCatalogRowSection
import com.nuviolinux.app.features.home.components.HomeContinueWatchingSection
import com.nuviolinux.app.features.home.components.HomeEmptyStateCard
import com.nuviolinux.app.features.home.components.HomeHeroReservedSpace
import com.nuviolinux.app.features.home.components.HomeHeroSection
import com.nuviolinux.app.features.home.components.HomeSkeletonHero
import com.nuviolinux.app.features.home.components.HomeSkeletonRow
import com.nuviolinux.app.features.home.components.ContinueWatchingLayout
...
import com.nuviolinux.app.features.watched.episodePlaybackId
import com.nuviolinux.app.features.watched.watchedItemKey
import com.nuviolinux.app.features.watchprogress.CachedInProgressItem
import com.nuviolinux.app.features.watchprogress.CachedNextUpItem
...
import com.nuviolinux.app.features.watchprogress.ContinueWatchingPreferencesUiState
import com.nuviolinux.app.features.watchprogress.ContinueWatchingItem
import com.nuviolinux.app.features.watchprogress.ContinueWatchingSortMode
import com.nuviolinux.app.features.watchprogress.isMalformedNextUpSeedContentId
import com.nuviolinux.app.features.watchprogress.isSeriesTypeForContinueWatching
import com.nuviolinux.app.features.watchprogress.nextUpDismissKey
import com.nuviolinux.app.features.watchprogress.parseReleaseDateToEpochMs
import com.nuviolinux.app.features.watchprogress.resolvedProgressKey
import com.nuviolinux.app.features.watchprogress.shouldTreatAsInProgressForContinueWatching
import com.nuviolinux.app.features.watchprogress.shouldUseAsCompletedSeedForContinueWatching
import com.nuviolinux.app.features.watchprogress.WatchProgressClock
...
import com.nuviolinux.app.features.watchprogress.WatchProgressSourceTraktPlayback
import com.nuviolinux.app.features.watchprogress.buildContinueWatchingEpisodeSubtitle
...
import com.nuviolinux.app.features.watchprogress.toUpNextContinueWatchingItem
...
import com.nuviolinux.app.features.watching.domain.isReleasedBy
...
import com.nuviolinux.app.features.home.components.HomeCollectionRowSection
...
import com.nuviolinux.app.features.home.components.continueWatchingHeroViewportReserveHeight
import com.nuviolinux.app.features.home.components.homeSectionHorizontalPaddingForWidth
import com.nuviolinux.app.features.home.components.rememberContinueWatchingLayout
    ...
    val cachedNextUpItems = remember(
        ...
        cachedSnapshots.first.mapNotNull { cached ->
            ...
            val sortTimestamp = if (item.isReleaseAlert) {
                com.nuviolinux.app.features.watchprogress.parseReleaseDateToEpochMs(item.released) ?: cached.lastWatched
            } else {
                cached.lastWatched
            }
...
internal fun cachedNextUpHasAired(
    ...
    com.nuviolinux.app.features.watchprogress.parseReleaseDateToEpochMs(cached.released)
...
private suspend fun resolveHomeNextUpCandidate(
    ...
    val sortTimestamp = if (item.isReleaseAlert) {
        com.nuviolinux.app.features.watchprogress.parseReleaseDateToEpochMs(item.released) ?: completedEntry.markedAtEpochMs
    } else {
...
private fun MetaDetails.videoForSeriesAction(action: SeriesPrimaryAction): MetaVideo? {
    ...
    return videos.firstOrNull { video ->
        com.nuviolinux.app.features.watchprogress.buildPlaybackVideoId(
            parentMetaId = id,
...
private fun CompletedSeriesCandidate.toContinueWatchingSeed(meta: com.nuviolinux.app.features.details.MetaDetails) =
    WatchProgressEntry(
...
private fun CachedNextUpItem.toContinueWatchingItem(): ContinueWatchingItem? {
    val alertState = com.nuviolinux.app.features.watchprogress.calculateReleaseAlertState(
        ...
        if (entry.parentMetaId != contentId) {
            ...
            if (mapping != null) {
                entry.copy(
                    ...
                    videoId = com.nuviolinux.app.features.watchprogress.buildPlaybackVideoId(
