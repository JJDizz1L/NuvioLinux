...
import com.nuviolinux.app.features.simkl.toSimklShowIdSiblings
...
private fun getActiveProviderSiblingMap(): Map<String, Set<String>> {
    ...
    val effectiveSource = effectiveWatchProgressSource(
        ...
        isProviderAuthenticated = { providerId ->
            com.nuviolinux.app.features.tracking.TrackingProviderRegistry.isAuthenticated(providerId)
        },
    )
