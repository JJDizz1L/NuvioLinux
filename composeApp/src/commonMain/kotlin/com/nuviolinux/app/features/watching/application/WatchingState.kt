package com.nuviolinux.app.features.watching.application
...
object WatchingState {
    ...
    fun isEpisodeWatched(
        ...
        if (episodeNumber != null) {
            return com.nuviolinux.app.features.simkl.SimklAnimeWatchedFallback.isWatched(videoId, episodeNumber)
        }
        return false
    }
