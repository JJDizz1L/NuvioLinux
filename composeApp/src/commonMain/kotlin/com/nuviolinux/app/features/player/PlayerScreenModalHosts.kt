...
import com.nuviolinux.app.features.details.MetaDetailsUiState
...
internal fun PlayerScreenModalHosts(
    ...
    onSubtitleCustomStylingToggle: () -> Unit,
    ...
    SubtitleModal(
        ...
        onCustomStylingToggle = onSubtitleCustomStylingToggle,
        customStylingEnabled = playerSettings.useLibass,
    ...
    if (showSubmitIntroModal && season != null && episode != null && !imdbId.isNullOrBlank()) {
        com.nuviolinux.app.features.player.skip.SubmitIntroDialog(
            imdbId = imdbId,
            season = season,
            episode = episode,
...
internal fun selectDownloadedEpisodeForPlayback(
    parentMetaId: String,
    episode: MetaVideo,
    onDownloadedEpisodeSelected: (com.nuviolinux.app.features.downloads.DownloadItem, MetaVideo) -> Unit,
): Boolean {
