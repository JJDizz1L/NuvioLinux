...
import com.nuviolinux.app.core.sync.decodeSyncFloat
import com.nuviolinux.app.core.sync.decodeSyncInt
import com.nuviolinux.app.core.sync.decodeSyncString
import com.nuviolinux.app.core.sync.decodeSyncStringSet
import com.nuviolinux.app.core.sync.encodeSyncBoolean
import com.nuviolinux.app.core.sync.encodeSyncFloat
import com.nuviolinux.app.core.sync.encodeSyncInt
import com.nuviolinux.app.core.sync.encodeSyncString
import com.nuviolinux.app.core.sync.encodeSyncStringSet
...
internal actual object PlayerSettingsStorage {
    ...
    private val store = DesktopStorage.store("player_settings")
    ...
    actual fun loadStreamAutoPlayNextEpisodeFallbackEnabled(): Boolean? = loadBoolean(streamAutoPlayNextEpisodeFallbackEnabledKey)
    actual fun saveStreamAutoPlayNextEpisodeFallbackEnabled(enabled: Boolean) = saveBoolean(streamAutoPlayNextEpisodeFallbackEnabledKey, enabled)
